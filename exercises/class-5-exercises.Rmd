...
coordinates(dag5.1) <- list( x=c(Hours=0,Stress=1,Canteen=2) , y=c(Hours=0,Stress=1,Canteen=0) )
drawdag( dag5.1 )
...
data <- read.csv(text = "Hours,Canteen,Stress
35,15,6
50,25,4
45,20,7
60,30,3
...
Level of IQ/ general intelligence <- number of instruments played + number of languages spoken
#### 5M4.
...
coordinates(dag5.1) <- list( x=c(A=0,D=1,M=2,L=1) , y=c(A=1,D=2,M=1, L=0) )
drawdag( dag5.1 )
```
